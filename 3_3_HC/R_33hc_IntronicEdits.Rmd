...
load(paste0(DATADIR,"33hc_EditingMetagenePlots_IntronExonUTRs.RData"))
...
load(paste0(DATADIR,"33hc_EditingMetagenePlots_IntronExonUTRs_D7vsControl.RData"))
names(pllist) <- gsub("intorns", "introns",names(pllist))
gb <- myf_plot(pllist)
...
load(paste0(DATADIR,"33hc_EditingMetagenePlots_IntronExonUTRs_D14vsControl.RData"))
names(pllist) <- gsub("intorns", "introns",names(pllist))
gb <- myf_plot(pllist)
...
```{r, p6, echo=T,fig.width=8,fig.height=6}
  ...
  for(i in 1:20){
    ...
    p1 <- ggdraw() + draw_image(paste0("A:/work/Kreidberg lab/Valerie/PAPER/33hc_PSVisulaization/Cntr/",rh$pic[i]),scale = 0.8) +
      ggtitle(paste0("Control\n",myy))+theme(plot.title = element_text(hjust = 0.5))
    
    p2 <- ggdraw() + draw_image(paste0("A:/work/Kreidberg lab/Valerie/PAPER/33hc_PSVisulaization/Exp/",rh$pic[i]),scale = 0.8)+ggtitle(paste0(gsub("_control","",rh$comparison[i]),"\n",myx))+theme(plot.title = element_text(hjust = 0.5))
