...
load(paste0(DATADIR,"33_EditingMetagenePlots_IntronExonUTRs.RData"))
...
load(paste0(DATADIR,"33_EditingMetagenePlots_IntronExonUTRs_D7vsControl.RData"))
names(pllist) <- gsub("intorns", "introns",names(pllist))
gb <- myf_plot(pllist)
...
load(paste0(DATADIR,"33_EditingMetagenePlots_IntronExonUTRs_D14vsControl.RData"))
names(pllist) <- gsub("intorns", "introns",names(pllist))
gb <- myf_plot(pllist)
