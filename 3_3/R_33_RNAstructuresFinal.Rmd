...
```{r, p2, echo=T,fig.width=8,fig.height=8}
  ...
  p1 <- ggdraw() + draw_image(paste0("A:/work/Kreidberg lab/Valerie/PAPER/33_PSVisulaization/Ref/",rhx$pic[110]),scale = 1)+
    ggtitle("control\nZfp398")+theme(plot.title = element_text(hjust = 0.5))
  p2 <- ggdraw() + draw_image(paste0("A:/work/Kreidberg lab/Valerie/PAPER/33_PSVisulaization/Alt/",rhx$pic[111]),scale = 1)+  
    ggtitle("Day-7\nZfp398")+theme(plot.title = element_text(hjust = 0.5))
  p3 <- ggdraw() + draw_image(paste0("A:/work/Kreidberg lab/Valerie/PAPER/33_PSVisulaization/Alt/",rhx$pic[110]),scale = 1)+  
    ggtitle("Day-14\nZfp398")+theme(plot.title = element_text(hjust = 0.5))
