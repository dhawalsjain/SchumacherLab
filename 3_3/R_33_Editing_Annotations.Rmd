...
![Workflow used to identify editing events](A:/work/Kreidberg lab/Valerie/PAPER/FIG/workflow_33.png)
...
```{r, p29, echo=T,fig.width=15,fig.height=8,warning=F}
  load(paste0(DATADIR,"33_EditingSites_Kataegis.RData"))
...
```{r, p34.1, echo=T,fig.width=6,fig.height=5}
 load(file=paste0(DATADIR,"33_cHMM_pValEnrichment.RData"))
...
```{r, p36, echo=T,fig.width=12,fig.height=6}
 load(paste0(DATADIR,"33_readDepth_EditLevels.RData"))
...
![Motif analyses](A:/work/Kreidberg lab/Valerie/PAPER/FIG/motifs_3by3.png)
...
![Motif analyses](A:/work/Kreidberg lab/Valerie/PAPER/FIG/motifs_3by3_GenomicAnno.png)


- Instead, I did the same analysis of findng motif, but without segragating the sequences into control, D7 or D14 groups. 
- In total, 2327 sequences (corresponding to 2327 editing sites collectively observed across control, D7 and D14) were used for predicting sequences using MEME suite. 
- Following motif was found in 487/2327 sites
- Please note: we can report this motif in the paper, which we also find in our control samples (above. Also, it is present in the range of 18%-30% across the conditions. Please refer control_motif in above plot)

![Motif analyses](A:/work/Kreidberg lab/Valerie/PAPER/FIG/motifs_ALLSeq_3by3.png)
