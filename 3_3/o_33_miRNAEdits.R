...
if(F){
  ...
  editedmiRs <- o
  save(editedmiRs, file=paste0(DATADIR,"33_EditedmiRNAs.RData"))
}
...
if(F){
  load(paste0(DATADIR,"33_EditingLevelReport_Anno.RData"))
  load(paste0(DATADIR,"33_DRE_DE_matrix.RData"))
  load(paste0(DATADIR,"33_miRSeedOverlaps_filtermiRNAs.RData"))
  ...
  miRgain <- p
  miRloss <- q
  save(miRgain,miRloss,file=paste0(DATADIR,"33_miRbinding_GainLoss_Timecourse.RData"))
  ...
  miRLGDF <- out
  save(miRLGDF,file=paste0(DATADIR,"33_miR_lossGain_dataframe.RData"))
...
if(F){
  ...
  load(paste0(DATADIR,"33_DRE_DE_matrix.RData"))
  load(paste0(DATADIR,"33_miRSeedOverlaps_filtermiRNAs.RData"))
  load(paste0(DATADIR,"33_miR_lossGain_dataframe.RData"))
  ...
  save(td,file=paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_SeedBased_ALL.RData"))
  ...
  save(miRLGDF,file=paste0(DATADIR,"33_miR_lossGain_dataframe_New.RData"))
  ...
  td$id <- NULL
  save(td,file=paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_SeedBased.RData"))
...
if(F){
  load(paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_SeedBased_ALL.RData"))
  load(paste0(DATADIR,"33_miRSeedOverlaps_filtermiRNAs.RData"))
  load(paste0(DATADIR,"genes.RData"))
  ...
  td <- merge(td1,td2,by="id")
  td$id <- NULL
  save(td,file=paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_SeedBased_forTarBaseValTargets.RData"))
...
if(F){
  load(paste0(DATADIR,"33_EditingLevelReport_Anno.RData"))
  load(paste0(DATADIR,"33_EditedmiRNAs.RData"))
  load(paste0(DATADIR,"33_DRE_DE_matrix.RData"))
  load(paste0(DATADIR,"DEExpression_DESeq2.RData"))
  load(paste0(DATADIR,"genes.RData"))
  ...
  sq$id <- NULL
  save(sq,file=paste0(DATADIR,"33_PlotDF_EditedMiRNA_CorrBn_valTarsNeditingLevels.RData"))
...
if(F){
  ...
  save(consv,file=paste0(DATADIR,"33_ConservedMiRTargets_EnrichAlongEdits.RData"))
...
if(F){
  ...
  load(paste0(DATADIR,"DEExpression_DESeq2.RData"))
  load(paste0(DATADIR,"genes.RData"))
  load(paste0(DATADIR,"33_ConservedMiRTargets_EnrichAlongEdits.RData"))
  miRLGDF <- consv
  rm(consv)
  ...
  td <- merge(td1,td2,by="id")
  td$id <- NULL
  save(td,file=paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_PredTargets.RData"))
