...
```{r, p3, echo=T,fig.width=12,fig.height=4, warning=F}
  load(paste0(DATADIR,"33_PlotDF_EditedMiRNA_CorrBn_valTarsNeditingLevels.RData"))
  td <- sq %>% unique
...
```{r, p4, echo=T,fig.width=8,fig.height=8}
  load(paste0(DATADIR,"33_miRbinding_GainLoss_Timecourse.RData"))
...
```{r, p7, echo=T,fig.width=8,fig.height=10}
    load(file=paste0(DATADIR,"33_miR_lossGain_dataframe_New.RData"))
...
```{r, p8, echo=T,fig.width=0.1,fig.height=0.1,fig.show='hide',results='hide',fig.keep='none',message=F}
 rm(td1,q,f,scaleFactor)
 load(paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_SeedBased.RData"))
...
```{r, p12, echo=T,fig.width=0.1,fig.height=0.1,fig.show='hide',results='hide',fig.keep='none',message=F}
 rm(td1,q,f,scaleFactor) 
 load(paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_SeedBased_forTarBaseValTargets.RData"))
...
```{r, p17, echo=T,fig.width=0.1,fig.height=0.1, warning=F}
  load(paste0(DATADIR,"33_PlotDF_miRNA_mRNA_correlations_PredTargets.RData"))
...
```{r, p17a, echo=T,fig.width=12,fig.height=5, warning=F}
 grid.arrange(grobs=pllist,nrow=1)
```
